...
FTE position</p>
			...
			<div id="social_info" class="col-lg-4 text-xs-right <?php echo getVisibility('social_info')?>">
				<?php if( (PAGE=="INDEX" AND getVisibility('social_info')=="sec-visible ") OR PAGE=="ADMIN") {?>
					...
					<p><a href="http://www.linkedin.com/in/aftab-hassan" style="color: #4e8fcc">www.linkedin.com/in/aftab-hassan</a><i class="fa fa-linkedin" aria-hidden="true"></i></p>
					<p><a href="http://www.github.com/aftab90" style="color: #4e8fcc">www.github.com/aftab90</a><i class="fa fa-github" aria-hidden="true"></i></p>
				<?php }?>	
			</div>
		</div>
			...
			<div class="col-lg-7">
				...
				<div id="projects" class="<?php echo getVisibility('projects')?> bottomSpace">
					...
					<div>
						...
						<ul>
							<li><a href="http://tinyurl.com/costprediction" style="color: #4e8fcc">http://tinyurl.com/costprediction</a> - Built Web application for insurance companies to forecast cost associated with a patient.</li>
						</ul>
					</div>
					<div>
						<h5>Multi Objective Medication Recommendation for Heart Failure patients - Thesis funded by MultiCare</h5>
						<ul>
							<li><a href = "http://tinyurl.com/multicaremed" style="color: #4e8fcc">http://tinyurl.com/multicaremed</a> - Construct Bayesian Network to discover causal relationship in patient data, Web application to recommend medications</li>
						</ul>
					</div>
					<div>
						<h5>Roger Federer Tennis analysis using Artificial Intelligence and 3D visualization on WebGL</h5>
						<ul>
							<li><a href = "http://tinyurl.com/tennisanalysis" style="color: #4e8fcc">http://tinyurl.com/tennisanalysis</a> - Predict match outcome using decision tree, discover trends, provide actionable insights, 3D Visual of tennis court</li>
						</ul>
					</div>
					<?php }?>
				</div>
